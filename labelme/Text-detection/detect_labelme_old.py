...
def run(
        ...
        source=dict_path['source'],  # file/dir/URL/glob/screen/0(webcam)
        data=ROOT / dict_path['yaml'],  # dataset.yaml path
        ...
        project=dict_path['override'],  # save results to project/name
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=dict_path['weight_best'], help='model path or triton URL')
    parser.add_argument('--source', type=str, default=dict_path['source'], help='file/dir/URL/glob/screen/0(webcam)')
    parser.add_argument('--data', type=str, default=ROOT / dict_path['yaml'], help='(optional) dataset.yaml path')
    ...
    parser.add_argument('--project', default=dict_path['override'], help='save results to project/name')
